...
export default function Gamecard(props) {
    return (
        <div className='my-2'>
            <div className="card bg-dark bg-opacity-75 border-light" style={{height:"30em"}}>
                <img src={props.Image} className="card-img-top px-2 py-2 rounded " style={{height:"13em"}} alt="..." />
