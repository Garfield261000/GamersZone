...
export default function Navbar({setdata,setshowModal}) {
                ...
                <div className="container-fluid mx-4">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav mr-auto mb-2 mb-lg-0 mx-2"  >
                            <li className="nav-item">
                                <button className="btn btn-dark fs-5 rounded-pill shadow-none" href="/" data-bs-toggle="modal" data-bs-target="#exampleModal" style={{textDecoration:"none"}} >Sign in</button>
                            </li>
                        </ul>
