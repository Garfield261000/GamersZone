                ...
                <div className="container-fluid mx-4">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form className="d-flex">
                            <input className="form-control me-2 rounded-pill" onChange={handlefilter} type="text" placeholder="Search Game..." aria-label="Search" />
                        </form>
                    </div>
                </div>
            </nav>
