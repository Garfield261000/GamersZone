                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav mb-2 mb-lg-2 ">
                        <li className="nav-item  ">
                            <a className="nav-link active fs-3" aria-current="page" href="#">Home</a>
                        </li>
                    </ul>
                    <ul className="navbar-nav me-auto mb-2 mb-lg-2 mx-3 ">
                        <li className="nav-item  ">
                            <a className="nav-link active fs-3" aria-current="page" href="#">Latest Games</a>
                        </li>
                    </ul>
                    <form className="d-flex">
                        <input className="form-control me-2 rounded-pill fs-5" type="search" placeholder="Search Game..." aria-label="Search" />
                        <button className="btn btn-outline-dark text-white rounded fs-4" type="submit">Search</button>
                    </form>
                </div>
            </div>
        </nav>
