...
export default function Navbar({setdata,showhome,setshowhome}) {
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mr-auto mb-2 mb-lg-0"  >
                            <li className="nav-item">
                                <Link className="navbar-brand fs-5"  to="/latestgames">Latest Games</Link>
                            </li>
                        </ul>
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0"  >
                            <li className="nav-item">
                                <Link className="navbar-brand fs-5" to="/contact">Contact Us</Link>
                            </li>
                        </ul>
                        <ul className="navbar-nav mr-auto mb-2 mb-lg-0 mx-2"  >
                            <li className="nav-item">
                                <button className="btn btn-dark fs-5 rounded-pill shadow-none" href="/" data-bs-toggle="modal" data-bs-target="#exampleModal1" style={{textDecoration:"none"}} >Log in</button>
                            </li>
                        </ul>
