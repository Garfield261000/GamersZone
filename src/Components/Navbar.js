...
export default function Navbar({showSearch,setshowSearch,setdata}) {
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mr-auto mb-2 mb-lg-0"  >
                            <li className="nav-item">
                                <Link className="navbar-brand fs-5" onClick={()=>{setshowSearch(true)}} to="/latestgames">Latest Games</Link>
                            </li>
                        </ul>
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0"  >
                            <li className="nav-item">
                                <Link className="navbar-brand fs-5" onClick={()=>{setshowSearch(false)}} to="/contact">Contact Us</Link>
                            </li>
                        </ul>
                        <ul className="navbar-nav mr-auto mb-2 mb-lg-0 mx-2"  >
                            <li className="nav-item">
                                <Link className="btn btn-dark fs-5 rounded-pill shadow-none" data-bs-toggle="modal" data-bs-target="#exampleModal" style={{textDecoration:"none"}} to="/signup">Sign in</Link>
                            </li>
                        </ul>
                        {showSearch && <form className="d-flex">
                            <input className="form-control me-2 rounded-pill" type="text" onChange={handlefilter} placeholder="Search Game..." aria-label="Search" />
                        </form>}
                    </div>
                </div>
            </nav>
